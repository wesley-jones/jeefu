            ...
            if entity:
                ...
                if entity[constants.DATE].date() != requested_date:
                    ...
                    dictionary = {
                        ...
                        'total_return': f'${entity[constants.TOTAL_RETURN]:,.2f}',
                        ...
                        'days_holding_cash': f'{entity[constants.TOTAL_DAYS_HOLDING_CASH]}',
                        'days_holding_btc': f'{entity[constants.TOTAL_DAYS_HOLDING_BTC]}',
