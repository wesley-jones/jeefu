...
filepath_of_model = 'models/highpriceclassifier/overpriced.joblib'

def train():
    # Load data
    data = pd.read_csv("models/highpriceclassifier/data/basic_classification_spike_sells.csv", parse_dates=[constants.DATE])
    google_trends = pd.read_csv("models/highpriceclassifier/data/google_trends_price_merged.csv")
    ...
    # data.to_csv('models/data/supervised.csv')
